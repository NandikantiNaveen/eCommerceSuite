...
public class ExtentManager {
	...
	public static ExtentReports createInstance() {
		...
		htmlReporter.config().setDocumentTitle("Web Shop Automation Test Reports");
		htmlReporter.config().setEncoding("utf-8");
		htmlReporter.config().setReportName("Web Shop Automation Test Results");
		extent = new ExtentReports();
		extent.setSystemInfo("Automation Tester", "Muneer");
		extent.setSystemInfo("Organization", "WebShop");
